...
function Page() {
  ...
  return (
    <div className=" flex flex-col justify-center items-center gap-2 p-3  ">
      ...
      <div className="flex flex-col gap-3 py-3 px-3 shadow-sm shadow-white rounded-lg ">
        ...
        {info?.trailer.embed_url && (
          <button className="h-12 w-28 bg-amber-500 transition ease-in duration-200 hover:bg-transparent shadow-sm shadow-white rounded-lg ">
